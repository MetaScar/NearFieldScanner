classdef E3649A < templates.BaseInstrument & ...
                  io.GPIBInstr & ...
    ...
    properties(Constant) 
        ...
        NUMBER_OF_OUTPUTS   = 2;    %Number of outputs for this instrument
        DEFAULT_CURRENT_LIM = 0.01; %Default Current Limit
    end

    methods
        function this = E3649A(varargin)
        ...
        function set(this,outputName,varargin)
            ...
            %now move to the specified channel
            this.select(index); 
    ...
    methods(Access=private)
        ...
        %% Operations
        function select(this,outputIndex)
            % Selects the Specified Output
            % fprintf(this.VisaObj,'INST:NSEL %d;\n',outputIndex);
            this.write('INST:NSEL %d;\n',outputIndex); 
        end
        ...
        function stateOut = getState(this)
            ...
            %will return false.
            % stateOut = strcmpi(query(this.VisaObj,'OUTP?;\n'),'ON'); 
